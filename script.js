...
const I18N = {
  ...
  de: {
    ...
    "faq.a2": "Wer frühzeitig anmeldet, hat den Kopf nach der Geburt frei und vermeidet Zeitdruck. Du kannst Optionen in Ruhe vergleichen, statt alles in den ersten hektischen Wochen zu erledigen.",
  ...
  en: {
    ...
    "faq.a2": "Signing up early means less stress after the birth. You can compare options calmly instead of doing everything in the first hectic weeks.",
  ...
  fr: {
    ...
    "faq.a2": "S'inscrire tôt évite le stress après la naissance. Vous comparez les options sereinement au lieu de tout faire dans les premières semaines.",
  ...
  it: {
    ...
    "faq.a2": "Iscriversi presto evita lo stress dopo la nascita. Puoi confrontare le opzioni con calma invece di fare tutto nelle prime settimane.",
